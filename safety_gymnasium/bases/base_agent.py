...
from safety_gymnasium.utils.task_utils import get_body_xvel, quat2mat
from safety_gymnasium.world import Engine
from safety_gymnasium.utils.task_utils import quat2euler, mat2quat
...
class BaseAgent(abc.ABC):  # pylint: disable=too-many-instance-attributes
    ...
    def quat(self) -> np.ndarray:
        ...
        Returns:
            np.ndarray: The Cartesian position of the agent.
        """
        return self.engine.data.body('agent').xquat.copy()
    ...
    def euler(self) -> np.ndarray:
        ...
        """
        return quat2euler(self.engine.data.body('agent').xquat.copy())
