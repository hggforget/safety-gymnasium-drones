...
from safety_gymnasium_drones import vector, wrappers
from safety_gymnasium_drones.tasks.safe_multi_agent.tasks.velocity.safe_mujoco_multi import make_ma
from safety_gymnasium_drones.utils.registration import make, register
from safety_gymnasium_drones.version import __version__
...
VERSION = 'v0'
ROBOT_NAMES = ('Point', 'Car', 'Doggo', 'Racecar', 'Ant', 'Quadrotor')
...
def __combine(tasks, agents, max_episode_steps):
    ...
    for task_name, task_config in tasks.items():
        ...
        for robot_name in agents:
            ...
            __register_helper(
                env_id=env_id,
                entry_point='safety_gymnasium_drones.builder:Builder',
...
__register_helper(
    ...
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_half_cheetah_velocity_v0:SafetyHalfCheetahVelocityEnv',
...
__register_helper(
    ...
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_hopper_velocity_v0:SafetyHopperVelocityEnv',
    max_episode_steps=1000,
...
__register_helper(
    ...
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_swimmer_velocity_v0:SafetySwimmerVelocityEnv',
    max_episode_steps=1000,
...
__register_helper(
    ...
    max_episode_steps=1000,
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_walker2d_velocity_v0:SafetyWalker2dVelocityEnv',
)

__register_helper(
    env_id='SafetyAntVelocity-v0',
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_ant_velocity_v0:SafetyAntVelocityEnv',
    max_episode_steps=1000,
...
__register_helper(
    ...
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_humanoid_velocity_v0:SafetyHumanoidVelocityEnv',
    max_episode_steps=1000,
)

__register_helper(
    env_id='SafetyHalfCheetahVelocity-v1',
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_half_cheetah_velocity_v1:SafetyHalfCheetahVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
__register_helper(
    ...
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_hopper_velocity_v1:SafetyHopperVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=3800.0,
)
...
__register_helper(
    ...
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_swimmer_velocity_v1:SafetySwimmerVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
__register_helper(
    ...
    max_episode_steps=1000,
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_walker2d_velocity_v1:SafetyWalker2dVelocityEnv',
)

__register_helper(
    env_id='SafetyAntVelocity-v1',
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_ant_velocity_v1:SafetyAntVelocityEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
__register_helper(
    ...
    entry_point='safety_gymnasium_drones.tasks.safe_velocity.safety_humanoid_velocity_v1:SafetyHumanoidVelocityEnv',
    max_episode_steps=1000,
)
...
def __combine_multi(tasks, agents, max_episode_steps):
    ...
    for task_name, task_config in tasks.items():
        ...
        for robot_name in agents:
            ...
            __register_helper(
                env_id=env_id,
                entry_point='safety_gymnasium_drones.tasks.safe_multi_agent.builder:Builder',
                spec_kwargs={'config': combined_config, 'task_id': env_id},
                max_episode_steps=max_episode_steps,
