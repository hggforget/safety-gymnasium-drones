...
from safety_gymnasium_drones.wrappers.rescale_action import SafeRescaleAction
...
def with_gymnasium_wrappers(
    ...
    *wrappers: Callable[[gymnasium.Env], gymnasium.Env],
    ...
    Example::
        ...
        >>> env = safety_gymnasium_drones.wrappers.with_gymnasium_wrappers(
        ...     safety_gymnasium_drones.make(env_id),
