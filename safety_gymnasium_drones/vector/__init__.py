...
from safety_gymnasium_drones.utils.registration import make as safety_make
from safety_gymnasium_drones.vector.async_vector_env import SafetyAsyncVectorEnv
from safety_gymnasium_drones.vector.sync_vector_env import SafetySyncVectorEnv
...
def make(
    ...
    **kwargs,
    ...
    Example::
        ...
        >>> env = safety_gymnasium_drones.vector.make('SafetyPointGoal1-v0', num_envs=3)
