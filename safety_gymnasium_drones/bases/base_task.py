...
from safety_gymnasium_drones.bases.underlying import Underlying
from safety_gymnasium_drones.utils.common_utils import ResamplingError, camel_to_snake
from safety_gymnasium_drones.utils.task_utils import theta2vec
...
class BaseTask(Underlying):  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def build_privileged_space(self) -> gymnasium.spaces.Dict:
        """Construct privileged space.  Happens only once during __init__ in Builder."""
    ...
    def build_goal_position(self) -> None:
        ...
        self.world_info.world_config_dict['geoms']['goal']['pos'] = self.world_info.layout[
            'goal'
        ]
    ...
    def build_staged_goal_position(self) -> None:
        ...
        # Move goal geom to new layout position
        self.world_info.world_config_dict['geoms']['staged_goal']['pos'] = self.world_info.layout['staged_goal']
