...
from safety_gymnasium_drones.tasks.safe_multi_agent.assets.group import GROUP
from safety_gymnasium_drones.tasks.safe_multi_agent.bases.base_object import Geom
...
class Hazards(Geom):  # pylint: disable=too-many-instance-attributes
    ...
    cost: float = 2.0  # Cost (per step) for violating the constraint
    ...
    def get_config(self, xy_pos, rot):
        ...
        geom = {
            ...
            'pos': np.r_[xy_pos, self.height],  # self.hazards_size / 2 + 1e-2],
            'rot': rot,
            'type': 'cylinder',
            'contype': 0,
            'conaffinity': 0,
