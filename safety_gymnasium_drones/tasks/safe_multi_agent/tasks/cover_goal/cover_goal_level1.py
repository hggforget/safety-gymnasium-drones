...
from safety_gymnasium_drones.tasks.safe_multi_agent.assets.free_geoms import Vases
from safety_gymnasium_drones.tasks.safe_multi_agent.assets.geoms import Hazards
