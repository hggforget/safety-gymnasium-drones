...
class BaseObject(abc.ABC):
    ...
    - :meth:`set_engine`: Set the engine instance, only called once in :class:`safety_gymnasium_drones.World`.
    ...
    - :attr:`name` (str): Name of the obstacle, used as key in :meth:`process_config` to fill configuration
      dictionary.
    - :attr:`engine` (:class:`safety_gymnasium_drones.world.Engine`): Physical engine instance.
    - :attr:`random_generator` (:class:`safety_gymnasium_drones.utils.random_generator.RandomGenerator`):
      Random generator instance.
    - :attr:`agent` (:class:`safety_gymnasium_drones.bases.base_agent.BaseAgent`): Agent instance.
    ...
    def set_engine(self, engine: Engine) -> None:
        ...
        Note:
            ...
            environment is instantiated in :meth:`safety_gymnasium_drones.World.bind_engine`.
...
class Mocap(BaseObject):
    ...
    def move(self) -> None:
        ...
        Note:
            This method is called in :meth:`safety_gymnasium_drones.bases.base_task.simulation_forward` before a physics
            step is executed.
        """
