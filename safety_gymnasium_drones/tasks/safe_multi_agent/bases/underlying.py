...
from safety_gymnasium_drones.tasks.safe_multi_agent import agents
from safety_gymnasium_drones.tasks.safe_multi_agent.assets.color import COLOR
from safety_gymnasium_drones.tasks.safe_multi_agent.assets.free_geoms import FREE_GEOMS_REGISTER
from safety_gymnasium_drones.tasks.safe_multi_agent.assets.geoms import GEOMS_REGISTER
from safety_gymnasium_drones.tasks.safe_multi_agent.assets.mocaps import MOCAPS_REGISTER
from safety_gymnasium_drones.tasks.safe_multi_agent.bases.base_object import FreeGeom, Geom, Mocap
from safety_gymnasium_drones.tasks.safe_multi_agent.utils.common_utils import MujocoException
from safety_gymnasium_drones.tasks.safe_multi_agent.utils.keyboard_viewer import KeyboardViewer
from safety_gymnasium_drones.tasks.safe_multi_agent.utils.random_generator import RandomGenerator
from safety_gymnasium_drones.tasks.safe_multi_agent.world import World
...
class Underlying(abc.ABC):  # pylint: disable=too-many-instance-attributes
    ...
    def _get_viewer(
        ...
        mode: str,
            ...
            safety_gymnasium_drones.utils.keyboard_viewer.KeyboardViewer
