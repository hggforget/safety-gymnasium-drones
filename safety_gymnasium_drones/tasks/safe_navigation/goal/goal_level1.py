...
from safety_gymnasium_drones.assets.free_geoms import Vases
from safety_gymnasium_drones.assets.geoms import Hazards
...
class GoalLevel1(GoalLevel0):
    ...
    def __init__(self, config) -> None:
        ...
        # self.placements_conf.extents = [-1.5, -1.5, 1, 1.5, 1.5, 3]

        self.placements_conf.extents = [-2.0, -2.0, 2.0, 2.0]

        self._add_geoms(Hazards(num=16, keepout=0.18))
        # self._add_geoms(Hazards(num=24, keepout=0.1))
